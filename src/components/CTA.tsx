...
const CTA = () => {
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      toast({
        title: "Thank you!",
        description: "Your message has been sent to contact@panio.io",
      });
  ...
  return (
    <section 
      id="contact" 
      className="py-20 px-6 md:px-10 bg-panio-offwhite"
      ref={sectionRef}
    >
      <div className="max-w-3xl mx-auto text-center">
        ...
        <Form {...form}>
          ...
          >
              ...
              render={({ field }) => (
                <FormItem className="flex items-start space-x-2">
                  ...
                  <div className="space-y-1 leading-none">
                    <FormLabel
                      htmlFor="gdpr"
                      className="text-sm text-panio-gray text-left"
                    >
            ...
            <Button 
              type="submit" 
              disabled={loading}
              className="bg-panio-accent hover:bg-panio-accent-dark text-white w-full"
            >
        ...
        <div className="mt-12 flex justify-center space-x-6">
          <a href="#" className="text-panio-accent hover:text-panio-accent-dark">
          ...
          <a href="mailto:contact@panio.io" className="text-panio-accent hover:text-panio-accent-dark">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
