            ...
            <div className="flex justify-center items-center py-4 lg:py-0">
              ...
              <div className="block lg:hidden">
                <svg width="24" height="80" viewBox="0 0 24 80" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <path d="M10.9393 79.0607C11.5251 79.6464 12.4749 79.6464 13.0607 79.0607L22.6066 69.5147C23.1924 68.9289 23.1924 67.9792 22.6066 67.3934C22.0208 66.8076 21.0711 66.8076 20.4853 67.3934L12 75.8787L3.51472 67.3934C2.92893 66.8076 1.97919 66.8076 1.3934 67.3934C0.807611 67.9792 0.807611 68.9289 1.3934 69.5147L10.9393 79.0607ZM10.5 0V78H13.5V0H10.5Z" fill="#5e869f"/>
                </svg>
              </div>
            </div>
